...
def Unet(input_size=(256, 256, 1)):
    ...
    # block 1
    x = Conv2D(filters=64, kernel_size=3, activation='relu', padding='same', name='block1_conv1')(inputs)
    ...
    # block 4
    x = Conv2D(filters=516, kernel_size=3, activation='relu', padding='same', name='block4_conv1')(x)
    x = Conv2D(filters=516, kernel_size=3, activation='relu', padding='same', name='block4_conv2')(x)
    skip4 = x
    x = MaxPooling2D(pool_size=(2, 2), name='block4_pool', padding='same')(x)

    # block 5
    x = Conv2D(filters=1024, kernel_size=3, activation='relu', padding='same', name='block5_conv1')(x)
    x = Conv2D(filters=1024, kernel_size=3, activation='relu', padding='same', name='block5_conv2')(x)
    ...
    x = Conv2D(filters=516, kernel_size=3, activation='relu', padding='same', name='block6_conv1')(x)
    x = Conv2D(filters=516, kernel_size=3, activation='relu', padding='same', name='block6_conv2')(x)
    ...
    x = Conv2D(filters=256, kernel_size=3, activation='relu', padding='same', name='block7_conv1')(x)
    x = Conv2D(filters=256, kernel_size=3, activation='relu', padding='same', name='block7_conv2')(x)
    ...
    x = Conv2D(filters=128, kernel_size=3, activation='relu', padding='same', name='block8_conv1')(x)
    x = Conv2D(filters=128, kernel_size=3, activation='relu', padding='same', name='block8_conv2')(x)
    ...
    x = Conv2D(filters=64, kernel_size=3, activation='relu', padding='same', name='block9_conv1')(x)
    x = Conv2D(filters=64, kernel_size=3, activation='relu', padding='same', name='block9_conv2')(x)
