...
def Unet(input_size=(256, 256, 1)):
    ...
    ch, cw = get_crop_shape(skip4, x)
    x = Cropping2D(cropping=(ch, cw), name='block6_cropping')(skip4)
    ...
    ch, cw = get_crop_shape(skip3, x)
    x = Cropping2D(cropping=(ch, cw), name='block7_cropping')(skip3)
    ...
    ch, cw = get_crop_shape(skip2, x)
    x = Cropping2D(cropping=(ch, cw), name='block8_cropping')(skip2)
    ...
    ch, cw = get_crop_shape(skip1, x)
    x = Cropping2D(cropping=(ch, cw), name='block9_cropping')(skip1)
